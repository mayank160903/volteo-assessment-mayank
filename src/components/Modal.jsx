...
const Modal = ({show, onClose, addTask}) => {
  return (
    show && (
        <div className='fixed rounded-2xl border border-gray-800 border-double cursor-default right-24 top-1/4 w-1/6 h-1/2 justify-center flex items-center text-black bg-white z-10'>
