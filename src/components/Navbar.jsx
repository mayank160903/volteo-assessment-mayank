...
const Navbar = () => {
  // Horizontal Navigation bar, fixed at the top for all pages and routes on Layout.jsx
  return (
    <header className="my-2 ml-2 mr-3 bg-white border rounded-xl border-gray-300 p-4 flex justify-between items-center">
      <div className="flex items-center">
        ...
        <div className="flex flex-col">
          ...
          <p>
            16 Crewmates ·{" "}
            <b className="font-medium text-[#1F4921]">09 Active</b>
          </p>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        <span className="text-md border rounded-2xl border-gray-400 px-4 py-2 text-gray-800">
          GMT +09:00
        </span>
